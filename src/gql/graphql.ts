...
export type ProjectQuery = { __typename?: 'query_root', projects_by_pk?: { __typename?: 'projects', id: number, name: string, description?: string | null } | null, identity_parties: Array<{ __typename?: 'identity_parties', first_name: string, last_name: string, party_id: number, party_roles: Array<{ __typename?: 'identity_party_roles', role_type: { __typename?: 'identity_role_type', value: string, description: string } }> }> };
